...
lags <- c("lag1", "lag2", "lag3", "lag4", "lag5", "lag6")
mainDF_compl <- mainDF[complete.cases(mainDF[lags]),]

llmm <- glmer(stim_choice ~ (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm0 <- glmer(stim_choice ~ stim_type + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm1 <- glmer(stim_choice ~ stim_type + lag1 + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm2 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm3 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm4 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm5 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + lag5 + (1|subj_idx), data = mainDF_compl, family = "binomial")
llmm6 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + lag5 + lag6 + (1|subj_idx), data = mainDF_compl, family = "binomial")
anova(llmm, llmm0, llmm1, llmm2, llmm3, llmm4, llmm5, llmm6, test = "LRT")
...
repeatorsDF_compl <- repeatorsDF[complete.cases(repeatorsDF[lags]),]

llmmr <- glmer(stim_choice ~ (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr0 <- glmer(stim_choice ~ stim_type + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr1 <- glmer(stim_choice ~ stim_type + lag1 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr2 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr3 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr4 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr5 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + lag5 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
llmmr6 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 +lag4 +lag5 + lag6 + (1|subj_idx), data = repeatorsDF_compl, family = "binomial")
anova(llmmr, llmmr0, llmmr1, llmmr2, llmmr3, llmmr4, llmmr5, llmmr6, test = "LRT")
...
alternatorsDF_compl <- alternatorsDF[complete.cases(alternatorsDF[lags]),]

llmma <- glmer(stim_choice ~ (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma0 <- glmer(stim_choice ~ stim_type + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma1 <- glmer(stim_choice ~ stim_type + lag1 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma2 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma3 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma4 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma5 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 + lag4 + lag5 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
llmma6 <- glmer(stim_choice ~ stim_type + lag1 + lag2 + lag3 +lag4 +lag5 + lag6 + (1|subj_idx), data = alternatorsDF_compl, family = "binomial")
anova(llmma, llmma0, llmma1, llmma2, llmma3, llmma4, llmma5, llmma6, test = "LRT")

summary(llmma1)
car::Anova(llmma1, type = 3)
BIC(llmma1)
confint(llmma1)
